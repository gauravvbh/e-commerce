  ...
  categories: [
    {
      ...
      sections: [
        ...
        },
        {
          ...
          name: 'Brands',
          items: [
            { id: 'fullnelson', name: 'Full Nelson', href: '#' },
            { id: 'myway', name: 'My Way', href: '#' },
            { id: 'rearranged', name: 'Re-Arranged', href: '#' },
            { id: 'counterfeit', name: 'Counterfeit', href: '#' },
            { id: 'signicantother', name: 'Significant Other', href: '#' },
          ],
        },
      ],
    },
    ...
    <div className="bg-white z-20 sticky top-0">
          ...
          >
                        ...
                        >
                          {section.items.map((item) => (
                            <li key={item.name} className="flow-root">
                              <NavLink to={`/${category.id}/${section.id}/${item.id}`} onClick={() => handleCategoryClick(category, section, item)}>
                                {item.name}
                              </NavLink>
                            </li>
                          ))}
            ...
            <div className="space-y-6 border-t border-gray-200 px-4 py-6">
              <div className="flow-root">
                <NavLink className="-m-2 block p-2 font-medium text-gray-900">
                  Sign in
                </NavLink>
              </div>
              <div className="flow-root">
      ...
      <header className="relative bg-white">
        {/* <p className="flex h-10 items-center justify-center bg-indigo-600 px-4 text-sm font-medium text-white sm:px-6 lg:px-8">
          Get free delivery on orders over $100 <CloseIcon/>
        </p> */}
        <TopBanner />
      ...
      <AuthModal open={openAuthModal} handleClose={handleCloseModal} />
    </div>
  )
}